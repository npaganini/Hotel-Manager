        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <div class="row" style="height: 45px;text-align: center">
                    <div class="col-xs-2">
                        <button onclick="disableButtons();location.href='${pageContext.request.contextPath}/products/addProduct'" type="button" id="add" class="btn btn-success btn-lg">
                            <a style="color: white">
                ...
                <div class="row">
                    <div class="col-xs-2">
                        <button type="button" onclick="disableButtons();location.href='${pageContext.request.contextPath}/rooms/home'" id="back" class="btn btn-danger btn-lg">
                            <a style="color: white">
