...
<div >
    ...
    <div class="row myheader vertical-align">
        <div class="col-xs-12" style="text-align: left">
            <div><spring:message code="product.disabled"/>!</div>
        </div>
    </div>
    <br>
    <br>
    <div class="row" style="font-size:x-large ">
        <div class="col" style="margin-left: 25px">
            <spring:message code="product.disabled.success"/>
        </div>
    </div>
    <br>
    <div class="row">
        <div class="col" style="margin-left: 25px">
            <button type="button" onclick="location.href='${pageContext.request.contextPath}/products'" class="btn btn-success btn-lg"><a style="color: white"><spring:message code="user.home"/></a></button>
        </div>
    </div>
