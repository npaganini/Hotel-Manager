...
<div >
    ...
    <div class="row">
        <div class="col" style="margin-left: 25px">
            <button type="button" class="btn btn-success btn-lg"><a href="${pageContext.request.contextPath}/logout" style="color: white"><spring:message code="user.home"/></a></button>
        </div>
    </div>
