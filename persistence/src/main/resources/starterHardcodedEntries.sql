...
insert into product (id, description, price, file_path, enable) values (default, 'Coca-Cola', 45.3, 'filePath', true);
insert into product (id, description, price, file_path, enable) values (default, 'Whisky', 150, 'filePath', true);
insert into product (id, description, price, file_path, enable) values (default, 'Papitas', 12, 'filePath', true);
insert into product (id, description, price, file_path, enable) values (default, 'Chocolates', 19, 'filePath', true);
