...
insert into product (id, description, price, filePath, enable) values (1, 'Coca-Cola', 45.3, 'filePath', true);
insert into product (id, description, price, filePath, enable) values (2, 'Whisky', 150, 'filePath', true);
insert into product (id, description, price, filePath, enable) values (3, 'Papitas', 12, 'filePath', true);
insert into product (id, description, price, filePath, enable) values (4, 'Chocolates', 19, 'filePath', true);
